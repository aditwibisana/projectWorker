    ...
    <div id="wrapper">
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav"><br>
                        <li><a href="/dashboard"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li><br>
                        <li><a href="/portofolio" class="active"><i class="lnr lnr-file-add"></i> <span>Project</span></a></li><br>
                        <li><a href="/laporan"><i class="lnr lnr-file-empty"></i> <span>Laporan</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
                                    ...
                                    <div class="modal-body">
                                        <form action="/project/create" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_project" class="form-control" id="exampleFormControlInput1" placeholder="Contoh : Desain UI UX">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Foto Project</label>
                                                <input type="file" name="foto_project" class="form-control" id="exampleFormControlInput1">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Katerangan</label>
                                                <input type="text" name="keterangan" class="form-control" id="exampleFormControlInput1" placeholder="Contoh : Tanggal Buat, Nama">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Kategori</label>
                                                <input type="text" name="kategori" class="form-control" id="exampleFormControlInput1" placeholder="Contoh : Teknologi, Kesehatan">
                                            </div>
