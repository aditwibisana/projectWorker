...
<body class="preload">
    <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="col-md-12 text-center"><a href="../index.html" class="brand"><img alt="Ben" src="../images/logo.svg" class="default"><img alt="Ben" src="../images/logo-white.svg" class="white"></a>
                        <ul class="main-nav">
                            <li><a href="../index.html" title="Work">Work</a>
                            </li>
                            <li><a href="/resume" title="About" class="active">About</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div id="sticky" class="col-md-12 col-sm-5">
                            <div class="selfie"><img alt="Ben" src="../images/about/profile.jpg" class="mt-lg"></div>
                            <h4>Ben Bryden</h4>
                            <table class="table mt-md">
                                ...
                                <tr>
                                    ...
                                    <td> <a href="#">LinkedIn</a><a href="#">Instagram</a><a href="#">Facebook</a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div id="sticky-holder">
                            <h1 class="animated-text">Headline</h1>
        ...
        <section class="content mt-xl fadein">
            ...
            <div class="row-fluid">
                <div class="col-md-12"><a href="../pages/work-single.html" class="smooth"><img alt="Ben" src="../images/portfolio/yellow-book.jpg"></a></div>
            </div>
        </section>
        <footer>
            <div class="container-fluid">
